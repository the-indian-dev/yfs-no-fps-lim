...
#define FSGUI_NEWFLTDLG_RAIN                              FsGetTextResource("newfltdlg/rain",L"Rain")
...
#define FSGUI_MAINDLG_INSTALLADDON                        FsGetTextResource("maindlg/installaddon",L"Install Add-on")
